...
public class AddressController {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Lista de direcciones", content = @Content(schema = @Schema(implementation = AddressRes.class))),
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "201", description = "Dirección creada", content = @Content(schema = @Schema(implementation = AddressRes.class))),
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Dirección actualizada", content = @Content(schema = @Schema(implementation = AddressRes.class))),
            @ApiResponse(responseCode = "400", description = "Dirección no encontrada o datos inválidos"),
            @ApiResponse(responseCode = "401", description = "No autenticado")
    })
    @PatchMapping("/{id}")
    public AddressRes patch(
            @Parameter(description = "ID de la dirección", example = "3") @PathVariable Long id,
